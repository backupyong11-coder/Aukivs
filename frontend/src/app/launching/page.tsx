  ...
  return (
    <div className="mx-auto max-w-[1600px] px-4 py-6 sm:px-6">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">런칭정리</h1>
        <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
          런칭 일정·상태를 정리하는 화면입니다. (연동·상세 기능은 추후 확장 예정입니다.)
        </p>
      </div>
      <div className="rounded-xl border border-dashed border-zinc-300 bg-zinc-50/80 px-4 py-12 text-center text-sm text-zinc-500 dark:border-zinc-700 dark:bg-zinc-900/40 dark:text-zinc-400">
        업로드정리·플랫폼정리의 런칭일 등과 연계하거나 전용 탭과 동기화할 수 있도록 준비 중입니다.
      </div>
    </div>
  );
}
