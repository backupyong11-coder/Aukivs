...
class CompanyProfileGetResponse(BaseModel):
    """GET /company-profile — 서버에 문서가 없으면 profile=null."""
...
class CompanyProfilePutResponse(BaseModel):
    ok: bool = True
    updated_at: str | None = None
...
class ProductionProcessGetResponse(BaseModel):
    """GET /production-process — 서버에 문서가 없으면 profile=null."""

    profile: dict[str, Any] | None = None
    updated_at: str | None = None


class ProductionProcessPutRequest(BaseModel):
    """PUT /production-process — 전체 프로필 교체."""
...
class ProductionProcessPutResponse(BaseModel):
    ok: bool = True
    updated_at: str | None = None


class SettlementGetResponse(BaseModel):
    """GET /settlement — 서버에 문서가 없으면 profile=null."""

    profile: dict[str, Any] | None = None
    updated_at: str | None = None


class SettlementPutRequest(BaseModel):
    """PUT /settlement — 전체 프로필 교체."""
...
class SettlementPutResponse(BaseModel):
    ok: bool = True
    updated_at: str | None = None
